...
public class RegexValidator {
     ...
     *         <p>
     *         The regex pattern is as follows: <br>
     *         - The address can only contain letters, numbers, commas, and spaces
     *         <br>
     */
     ...
     *         - The password must contain at least one special character in the
     *         following set: @ $ ! % * ? & <br>
     */
     ...
     *         - The URL must contain letters, numbers, +, &, @, #, /, % , ?, =, ~,
     *         _, !, :, ;, or . <br>
     ...
     *         - The SSN must not have all zeros in the first 3 or last 4 digits
     *         <br>
     ...
     *         - The credit card number must start with 4, 51, 52, 53, 54, or 55
     *         <br>
     ...
     *         - The IBAN can optionally contain up to 16 alphanumeric characters
     *         <br>
     */
     ...
     *         <p>
     *         The regex pattern is as follows: <br>
     *         - The ISBN must start with "ISBN" (case insensitive) followed by a
     *         hyphen and the number 1, 0, or 3, or just the number 1, 0, or 3 <br>
     *         - The ISBN must contain 10 digits, each separated by a hyphen,
     *         underscore, or nothing <br>
    ...
    /**
     * Validates an image file using regex.
     *
     * @param image Image file name to validate
     * @return true if the image file is valid, false otherwise
     *         <p>
     *         The regex pattern is as follows: <br>
     *         - The image file must have a valid extension (jpg, jpeg, png, gif)
     *         <br>
     */
     ...
     *         The regex pattern is as follows: <br>
     *         - The year must be between 1900 and 2099 <br>
     *         - The year must not contain any other characters <br>
     */
    ...
    /**
     * Validates a month using regex.
     *
     * @param month Month to validate
     * @return true if the month is valid, false otherwise
     *         <p>
     *         The regex pattern is as follows: <br>
     *         - The month must be a number between 1 and 12 <br>
     *         - The month must be represented by two digits, the first being 0 or 1
     *         <br>
     *         - The month must not contain any other characters <br>
     */
    ...
    /**
     * Validates a day using regex.
     *
     * @param day Day to validate
     * @return true if the day is valid, false otherwise
     *         <p>
     *         The regex pattern is as follows: <br>
     *         - The day must be a number between 1 and 31 <br>
     *         - The day must be represented by two digits, the first being 0, 1, 2,
     *         or
     *         3 <br>
     *         - The day must not contain any other characters <br>
     */
